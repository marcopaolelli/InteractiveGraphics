...
function addBackground() {
	...
	material.map   = new THREE.TextureLoader().load('images/galaxy.png');
...
var onMouseMove = function ( event ) {
	...
	var ipo =  Math.sqrt(Math.pow(mouse.x , 2 ) + Math.pow(mouse.y , 2 ));
	//  /* // decommentare qui  per testare il secondo metodo, funge tutto 
	if (movementX >=0 ) {
	...
	//  */
	 // FUNZIONA BENE, però non va mentre si muove
	/*if (movementX != 0 || movementY != 0) {
		//pivot.rotation.set(0,0, Math.sqrt(Math.pow(mouse.x , 2 ) + Math.pow(mouse.y , 2 )) );
		//pivot.rotateZ((Math.atan(mouse.y/mouse.x)*180)/Math.PI);
		if(mouse.x >0 && mouse.y>0 ){
			pivot.rotation.z = (Math.asin(mouse.y/ ipo));
			console.log(Math.asin(mouse.y/ ipo));
			console.log((Math.asin(mouse.y/ ipo)*180)/Math.PI);
			console.log('+++++++++++++++++++++++++++++++++++++++');
		}
		if(mouse.x <0 && mouse.y>0 ){
			pivot.rotation.z = (180-((Math.asin(mouse.y/ ipo)*180)/Math.PI))*Math.PI/180;
			console.log((180-((Math.asin(mouse.y/ ipo)*180)/Math.PI))*Math.PI/180);
			console.log(180-(Math.asin(mouse.y/ ipo)*180)/Math.PI);
			console.log('+++++++++++++++++++++++++++++++++++++++');
		}
		if(mouse.x <0 && mouse.y<0 ){
			pivot.rotation.z = (180-((Math.asin(mouse.y/ ipo)*180)/Math.PI))*Math.PI/180;
		...
		if(mouse.x >0 && mouse.y<0 ){
			pivot.rotation.z = (360+((Math.asin(mouse.y/ ipo)*180)/Math.PI))*Math.PI/180;
			console.log((360+((Math.asin(mouse.y/ ipo)*180)/Math.PI))*Math.PI/180);
			console.log(360+(Math.asin(mouse.y/ ipo)*180)/Math.PI);
			console.log('+++++++++++++++++++++++++++++++++++++++');
		}
	}*/	
